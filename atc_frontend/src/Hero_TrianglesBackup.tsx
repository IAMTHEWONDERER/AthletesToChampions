...
export default function Hero() {
  const backgrounds = [
    "linear-gradient(135deg, #9D4EDD, #5A189A)", // Strong Purple
    "linear-gradient(135deg, #00B4D8, #03045E)", // Deep Blue
    "linear-gradient(135deg, #52B788, #1B4332)", // Vibrant Green
    "linear-gradient(135deg, #FFB703, #E85D04)", // Vivid Yellow/Orange
    "linear-gradient(135deg, #EF233C, #902923)"  // Intense Red
  ];
